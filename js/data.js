...
const qnaList = [
    {
        ...
        a: [
            {answer: '무슨소리야 오히려좋아!', type: ['0', '1', '3', '4', '6', '9']},
            {answer: 'ㅇㅈ 좀 기 빨려...', type: ['2', '5', '7', '8', '10', '11']},
        ]
    },
    {
        q: '마피아게임을 할 때 나는...',
        a: [
            {answer: '영문도 모른 채 마피아로 몰리는 편', type: ['0', '1', '3', '4', '6', '8']},
            {answer: '딱봐도 쟤가 마피아네. 거봐 맞지?', type: ['2', '5', '7', '9', '10', '11']},
            {answer: '나나나나 내가 마피아임 아무튼그럼', type: ['2', '5', '7', '9', '10', '11']},
            {answer: '마피아게임 별로 안 좋아해ㅠㅠ', type: ['2', '5', '7', '9', '10', '11']},
        ]
    },
    {
        q: '게임에서 지기보단 이기고 싶다.',
        a: [
            {answer: '게임을 하면 이겨야지!', type: ['0', '3', '4', '10']},
            {answer: '져도 재밌었음 상관없어!', type: ['2', '9', '11']},
            {answer: '승패보단 내 재미가 우선이다.', type: ['2', '9', '11']},
        ]
    },
    {
        q: '팀원이 실수를 한다면...',
        a: [
            {answer: '빡친다. 그냥 개빡친다.', type: ['2', '4', '8', '10']},
            {answer: '그럴 수 있지~ 즐겜최고~', type: ['0', '5']},
            {answer: '어차피 내가 캐리해서 상관없다.', type: ['1', '3', '6']},
            {answer: '사실 그 팀원이 나야...ㅠㅠ', type: ['1', '3', '6']},
        ]
    },
    {
        q: '보드게임카페 가자! 친구 몇 명 부를까?',
        a: [
            {answer: '네 명이 제일 재밌지!', type: ['0', '3', '6']},
            {answer: '6명 ~ 8명?', type: ['1', '7', '9',]},
            {answer: '사람 많은 건 싫어! 두 명!', type: ['2', '4', '5', '11']},
            {answer: '난 혼자가 좋아.', type: ['8', '10']},
        ]
    },
    {
        q: '예상치 못한 상황이 벌어진다면...',
        a: [
            {answer: '일단 몸부터 나가는 타입', type: ['3', '4', '5', '6', '7', '9', '10', '11']},
            {answer: '일단 머리부터 굴리는 타입', type: ['0', '1', '2', '8']},
            {answer: '나는 둘 다 굳어버리는데...', type: ['0', '1', '2', '8']},
        ]
    },
    {
        q: '게임 할 때 머리 쓰는 편이야?',
        a: [
            {answer: '냅다 두뇌 풀가동!', type: ['0', '1', '4', '8']},
            {answer: '뇌 빼고 감으로 하는 편', type: ['2', '3', '5', '10', '9']},
            {answer: '', type: ['6', '7', '10', '11']},
        ]
    },
    {
        q: '보드게임 카페에서 게임을 고를 때...',
        a: [
            {answer: '갈 친구가 있는지부터 물어봐줄래?', type: ['1', '6', '8']},
            {answer: '유명한, 아는 게임만 한다.', type: ['3', '7', '11']},
            {answer: '룰 몰라도 냅다 가져와서 한다.', type: ['2', '5', '10']},
            {answer: '이미 장르별로 싹다 파악하고 있다.', type: ['0', '4', '9']},
        ]
    },
    {
